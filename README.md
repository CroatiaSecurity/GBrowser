...
> **Need H.264 / AAC (Discord embeds, many HTML5 players) on Windows?** Use [Ceprkac 0.6.8](https://github.com/CroatiaSecurity/Ceprkac) — the WebView2 edition. GBrowser's shipped Qt WebEngine does not include MPEG-LA proprietary codecs.
